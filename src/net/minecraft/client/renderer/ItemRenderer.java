...
public class ItemRenderer {
    ...
    private float getSwingProgress(float partialTicks) {
        float swingProgress = Minecraft.getMinecraft().thePlayer.getItemInUseDuration() - partialTicks;
        if (swingProgress < 0) {
            swingProgress = 0;
        }
        swingProgress /= 20.0F; // 调整动画速度
            ...
            if (this.itemToRender.getItem() == Items.filled_map) {
                ...
                switch (enumaction) {
                    ...
                    case DRINK:
                        ...
                        this.transformFirstPersonItem(f, this.getSwingProgress(partialTicks));
                        break;
