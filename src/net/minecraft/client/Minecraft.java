...
import cn.tianyu.client.gui.MainMenuGui;
import cn.tianyu.client.gui.StartPage;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("font/font/CN_tianyu.png");
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new StartPage(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(new StartPage());
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(TYClient.NAME + " Loading... ");
    ...
    private void setInitialDisplayMode() throws LWJGLException {
        if (this.fullscreen) {
            ...
            this.displayWidth = (int) (1280 * 0.80);
            this.displayHeight = (int) (720 * 0.80);
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                ...
                inputstream1 = this.getClass().getResourceAsStream("/assets/minecraft/client/icon/32.png");
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
        ...
        theCrash.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>() {
            public String call() throws Exception {
                ...
                return !s.equals("vanilla") ? "Definitely; TYClient brand changed to \'" + s + "\'" : (Minecraft.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and client brand is untouched.");
            }
        });
